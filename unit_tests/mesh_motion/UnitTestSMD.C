...
TEST(meshMotion, airfoil_smd_update)
{
  ...
  f_np1.x() = 250.0; f_np1.y() = 350.0; f_np1.z() = 700.0;
  m_np1.x() = 700.0; m_np1.y() = 700.0; m_np1.z() = 500.0;
  ...
  const double gold_x0 = 0.09994737561871818;
  const double gold_x1 = 0.1999704953673295;
  const double gold_x2 = 0.00989693602549779;

  const double gold_xdot0 = -0.010501010323812237;
  const double gold_xdot1 = -0.005887545748310873;
  const double gold_xdot2 = -0.020566053868921862;
