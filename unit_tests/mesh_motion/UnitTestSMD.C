...
TEST(meshMotion, airfoil_smd_update2)
{
  ...
  // appropriate expected values of the states at t=n+1
  const double gold_x0 = 0.10203122803905001;
  const double gold_x1 = 0.20304235802403078;
  const double gold_x2 = 0.009482328212290348;

  const double gold_xdot0 = 0.2062382481551047;
  const double gold_xdot1 = 0.3084569299653236;
  const double gold_xdot2 = -0.05352634312573554;
