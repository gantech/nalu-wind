...
SolutionOptions::initialize_turbulence_constants() 
{
  ...
  turbModelConstantMap_[TM_sas_zetaTwo] = 3.51;
  turbModelConstantMap_[TM_sas_sigmaPhi] = 2./3.;
  turbModelConstantMap_[TM_sas_C] = 2.0;
  turbModelConstantMap_[TM_sas_Cs] = 0.11;
}
