  ...
  stk::mesh::Part *part)
{
  ...
  if ( functionName == "steady_2d_thermal" ) {
    ...
    throw std::runtime_error(
      ...
      "kovasznay_dpdx, smd_mms_velocity, smd_mms_pressure, smd_mms_dpdx, convecting_taylor_vortex, "
      "convecting_taylor_vortex_dpdx, wind_energy_taylor_vortex, wind_energy_taylor_vortex_dpdx, "
      "BoussinesqNonIso user functions supported");
  }
